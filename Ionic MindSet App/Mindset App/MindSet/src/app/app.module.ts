...
@NgModule({
  ...
  entryComponents: [],
  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule, ModalNamePageModule, ModalEmailPageModule, ModalPsychologistEmailPageModule, IonicStorageModule.forRoot()], 
  providers: [
    StatusBar,
    SplashScreen,
