...
<?php 
    $comments = array();
    $comments[0] = array(
            array('username' => 'Bananaman24',
                'comment' => 'I LIKE BANANANANANANANANA',
    ),
            array(
                'username' => 'StinkyCheese',
                'comment' => 'Cheesy'
            ),
            array(
                'username' => 'MonkeyLord777',
                'comment' => 'Strategic Launch Detected'
            )
    ...
    $comments[1] = array(
        ...
        array(
            ...
            'comment' => 'The burgers are better'
        )
    );
    $comments[2] = array(
        array(
            'username' => 'pastry',
            'comment' => 'Like the chicken'
        ),
        array(
            'username' => 'Mother',
            'comment' => "Don't drink the blue vials"
        ),
        array(
            'username' => 'What in the/..',
            'comment' => 'Strategic Launch Detected'
        )
    );
...
$post1 = new Post("BananaBran", "banana.jpg", "Welcome to the state of bananaBRan", "It was the year 3000", $comments[0]);
$post2 = new Post("The Mother", "mother.jpg", "**Secretly a volitile**", "2014", $comments[1]);
$post3 = new Post("Pi", "Raspi-PGB001.png", "The MicroComputer for NERDS", "14/7/2019", $comments[2]);
        ...
        <div class="col-lg-6">
            ...
            <div>
                <?php foreach ($posted->commented as $single) { ?>
                    ...
                    <div class="card">
                        <div class="card-header"><?= $single['username']?></div>
                        <div class="card-body">
                            <p class="card-text"><?= $single['comment']?></p>
                        </div>
                    </div>
