...
print("Welcome to sql_food.py, this will find all businesses that have had at least one violation, and add them to a new database table, and list them here")
...
print("\nInitiating First Select - Selecting businesses with at least one violation")
...
print("Selecting in order of violations\n")
