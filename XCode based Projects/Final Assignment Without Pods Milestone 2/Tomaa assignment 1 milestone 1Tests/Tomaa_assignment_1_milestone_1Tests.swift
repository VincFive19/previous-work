...
class Tomaa_assignment_1_milestone_1Tests: XCTestCase {
    ...
    override func setUp() {
        ...
        boardGame = BoardGameJSONTEST("Jenga", "Jenga for Jengaring", "Jenga is a fun tower stacking board game", "jengaimageidentifier", "pro", "Con", "test")
